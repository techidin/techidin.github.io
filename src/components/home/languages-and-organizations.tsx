...
export const organizations = [
  {
    ...
    status: 'Volunteer (2017 - Present)',
    illustration: <AiIllustration />,
  },
]

// Languages And Organizations
export default function LanguagesAndOrganizations() {
  return (
    <div className="order-1 col-span-12 flex flex-col border-x border-gray-30 dark:border-gray-500 lg:order-1 lg:col-span-5 lg:flex-col xl:col-span-4">
      <motion.div
        {...whileInView}
        whileInView="show"
        transition={transitions.default}
        variants={variants.fadeInDown}
        className="flex flex-1 flex-col border-t border-gray-30 px-4 py-5 md:px-8 md:py-8 dark:border-gray-500 lg:border-t-0"
      >
        <SectionTitle title="Languages" icon={Icons.Suitcase} />
      ...
      <motion.div
        ...
        transition={transitions.default}
        variants={variants.fadeInDown}
        className="flex flex-1 flex-col border-t border-gray-30 px-4 py-5 md:px-8 md:py-8 dark:border-gray-500"
      >
